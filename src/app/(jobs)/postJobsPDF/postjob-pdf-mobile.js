  ...
  return (
    <div className="w-screen overflow-x-auto overflow-y-auto p-6 flex flex-col justify-start bg-greyscale-50">
      <div className="p-4 w-[100%] h-auto flex flex-col items-start justify-start gap-6 bg-white">
        ...
        />
        <InputField id="project-title" label="Project Title" width="w-[70vw]" />
        <InputField id="qualification" label="Qualification" width="w-[70vw]" />
        <InputField
          label="Stipend"
          id="stipend"
          width="w-[70vw]"
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center justify-between space-x-2 p-2 border border-[#D1B3B8] w-[70vw]">
      ...
      <div className="flex w-[100%] justify-center items-center">
        <div className="flex gap-6">
          <button className="bg-[#650010] text-center w-[20vw] p-2 text-white text-[14px]">
            Submit
          </button>
          <button className="border border-[#650010] text-center w-[20vw] p-2 text-[#650010] text-[14px]">
            Cancel
          </button>
        </div>
      </div>
