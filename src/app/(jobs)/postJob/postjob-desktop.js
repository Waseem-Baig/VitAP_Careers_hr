  ...
  return (
    <div className="w-[80vw] overflow-x-scroll overflow-y-scroll h-[90vh] p-[12px_24px] flex flex-col justify-start items-center bg-greyscale-50 gap-[4rem]">
      <div className="bg-white w-[100%] h-auto p-[1.5rem] flex flex-col gap-[1rem]">
        ...
        />
        <InputField id="qualification" label="Qualification" width="w-[25vw]" />
        <InputField
      ...
      <div className="bg-white w-[100%] h-auto p-[1.5rem] flex flex-col gap-[1rem]">
        ...
        <input
          type="text"
          className={`border border-[#D1B3B8] w-[50vw] p-2 placeholder-[rgba(51, 51, 51, 0.40)] placeholder-font-montserrat placeholder-text-[12px] placeholder-font-normal placeholder-leading-[18.524px]`}
        ...
        />
        <button className="border border-[#650010] text-center w-[15vw] p-2 text-[#650010] text-[14px]">
          + Add one More Duty
        </button>
        <InputField
          id="eligibility"
